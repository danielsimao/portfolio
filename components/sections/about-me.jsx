        ...
        <BasicReveal trigger={<div className="text-left" />}>
          ...
          <div>
            <p className="mb-5 text-light font-carrois text-lg text-bold">
              I&apos;m a Fullstack Developer from Portugal, passionate about
              building beautiful interactive user-friendly experinces. With 4+
              years in the game, frontend is my jam, but I know my way in the
              backend.
            </p>
            <p className="mb-5 text-light font-carrois text-lg text-bold">
              I&apos;m a, problem solving enthusiast, always looking forward to
              improve myself and helper others.
            </p>
